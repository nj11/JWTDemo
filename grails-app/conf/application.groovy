...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.jwtDemo.UserAuthority'
grails.plugin.springsecurity.authority.className = 'com.jwtDemo.Authority'
